...
export function ProfileScreen({ onReplayWelcome, onReplayOnboarding }: { onReplayWelcome: () => void; onReplayOnboarding: () => void }) {
  ...
  // Sur le web, Alert.alert de React Native ne fait rien : le bouton semblait
  // mort dans le navigateur. On y utilise la confirmation du navigateur.
  const confirmReset = () => { resetProfile(); setSaved(false); setError(null); };
  const requestReset = () => Platform.OS === 'web'
    ? (typeof window !== 'undefined' && window.confirm('Effacer ton profil ? Tes informations personnelles seront réinitialisées. Ton journal de repas sera conservé.') ? confirmReset() : undefined)
    : Alert.alert(
    'Effacer ton profil ?',
...
const styles = StyleSheet.create({
  ...
  settingBody: { flex: 1 },
  settingLabel: { color: colors.ink, fontSize: 13, fontFamily: fonts.bold },
  settingCopy: { color: colors.muted, fontSize: 12, fontFamily: fonts.medium, lineHeight: 17, marginTop: 4 },
  ...
  guidedTitle: { color: colors.violetInk, fontSize: 16, fontFamily: fonts.extrabold },
  guidedCopy: { color: colors.inkSoft, fontSize: 13, lineHeight: 18, fontFamily: fonts.semibold },
  orLine: { color: colors.muted, fontSize: 13, fontFamily: fonts.bold, textAlign: 'center', marginTop: 14 },
  ...
  replayText: { color: colors.violet, fontSize: 12, fontFamily: fonts.extrabold },
  savedNotice: { color: colors.sageDark, fontSize: 12, fontFamily: fonts.medium, lineHeight: 18, marginTop: 12 },
  error: { color: colors.inkSoft, backgroundColor: colors.goldPale, padding: 13, borderRadius: 12, fontSize: 12, fontFamily: fonts.medium, lineHeight: 18, marginTop: 12 },
  formHelp: { color: colors.inkSoft, fontSize: 12, fontFamily: fonts.medium, lineHeight: 17, marginTop: 14 },
  ...
  title: { color: colors.ink, fontSize: 32, fontFamily: fonts.bold, letterSpacing: -1, marginTop: 5 },
  subtitle: { color: colors.muted, fontSize: 13, fontFamily: fonts.medium, lineHeight: 19, maxWidth: 320, marginTop: 7 },
  guideWrap: { marginTop: 20 },
  sectionTitle: { color: colors.ink, fontSize: 17, fontFamily: fonts.bold, marginTop: 28, marginBottom: 11 },
  ...
  nameInput: { backgroundColor: colors.background, borderRadius: 13, borderWidth: 1, borderColor: colors.line, color: colors.ink, fontSize: 14, fontFamily: fonts.semibold, paddingHorizontal: 13, paddingVertical: 12 },
  goalList: { gap: 9 },
  ...
  goalLabel: { color: colors.inkSoft, fontSize: 13, fontFamily: fonts.semibold },
  goalLabelActive: { color: colors.ink, fontFamily: fonts.bold },
  goalDetail: { color: colors.muted, fontSize: 12, fontFamily: fonts.medium },
  ...
  segmentText: { color: colors.muted, fontSize: 12, fontFamily: fonts.semibold },
  segmentTextActive: { color: colors.ink, fontFamily: fonts.bold },
  ...
  fieldLabel: { color: colors.muted, fontSize: 12, fontFamily: fonts.bold, marginBottom: 6 },
  ...
  optionText: { color: colors.inkSoft, fontSize: 12, fontFamily: fonts.semibold },
  ...
  numberInput: { flex: 1, color: colors.ink, fontSize: 14, fontFamily: fonts.bold, paddingVertical: 11 },
  numberSuffix: { color: colors.muted, fontSize: 12, fontFamily: fonts.medium },
  formulaInfo: { flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10, borderTopWidth: 1, borderTopColor: colors.line },
  formulaLabel: { color: colors.muted, fontSize: 12, fontFamily: fonts.medium },
  formulaValue: { color: colors.inkSoft, fontSize: 12, fontFamily: fonts.bold },
  formulaValueStrong: { color: colors.sageDark, fontSize: 13, fontFamily: fonts.extrabold },
  ...
  manualInput: { flex: 1, color: colors.ink, fontSize: 25, fontFamily: fonts.bold, paddingVertical: 12 },
  manualSuffix: { color: colors.muted, fontSize: 13, fontFamily: fonts.semibold },
  notice: { flexDirection: 'row', gap: 9, alignItems: 'flex-start', backgroundColor: colors.sagePale, borderRadius: 14, padding: 12 },
  noticeText: { flex: 1, color: colors.inkSoft, fontSize: 12, fontFamily: fonts.medium, lineHeight: 15 },
  ...
  resultLabel: { color: '#C8C9FF', fontSize: 12, fontFamily: fonts.medium },
  resultValue: { color: colors.white, fontSize: 26, fontFamily: fonts.bold, marginTop: 5, letterSpacing: -0.5 },
  resultUnit: { fontSize: 12, fontFamily: fonts.medium, color: '#C8C9FF' },
  ...
  saveText: { color: colors.white, fontSize: 14, fontFamily: fonts.bold },
  ...
  resetTitle: { color: colors.ink, fontSize: 13, fontFamily: fonts.bold },
  resetCopy: { color: colors.muted, fontSize: 12, fontFamily: fonts.medium, lineHeight: 15, marginTop: 4 },
  ...
  resetButtonText: { color: colors.coral, fontSize: 12, fontFamily: fonts.extrabold },
  ...
  backupText: { color: colors.inkSoft, fontSize: 12, fontFamily: fonts.medium, lineHeight: 17 },
  ...
  motionChoiceText: { color: colors.inkSoft, fontSize: 13, fontFamily: fonts.bold },
  ...
  motionStatusText: { flex: 1, fontSize: 13, lineHeight: 18, fontFamily: fonts.semibold },
  ...
  motionTestTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.extrabold },
  motionTestCopy: { color: colors.muted, fontSize: 13, lineHeight: 18, fontFamily: fonts.semibold },
  demoLink: { alignItems: 'center', paddingVertical: 18 },
  demoLinkText: { color: colors.muted, fontSize: 12, fontFamily: fonts.medium, textDecorationLine: 'underline' },
});
