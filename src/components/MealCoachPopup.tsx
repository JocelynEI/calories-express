...
const styles = StyleSheet.create({
  ...
  heading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, eyebrow: { color: colors.sageDark, fontSize: 12, letterSpacing: 1, fontWeight: '800' },
  close: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' }, cross: { color: colors.navy, fontSize: 26 },
  row: { flexDirection: 'row', alignItems: 'center', gap: 8 }, title: { fontSize: 17, lineHeight: 23, color: colors.navy, fontWeight: '800' }, copy: { fontSize: 13, lineHeight: 19, color: colors.inkSoft, marginTop: 7 },
  footer: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', gap: 7 }, linkButton: { minHeight: 44, justifyContent: 'center', paddingHorizontal: 4 }, link: { color: colors.sageDark, fontSize: 12, fontWeight: '700' },
});
