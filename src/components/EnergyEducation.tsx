...
const styles = StyleSheet.create({
  ...
  cardTitle: { color: colors.navy, fontSize: 15, fontWeight: '700' },
  planRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  rowCopy: { flex: 1, minWidth: 0 },
  label: { color: colors.inkSoft, fontSize: 12, fontWeight: '600', flexShrink: 1 },
  small: { color: colors.muted, fontSize: 12, lineHeight: 15, marginTop: 2 },
  number: { color: colors.navy, fontSize: 16, fontWeight: '800' },
  ...
  explanationTitle: { color: colors.navy, fontSize: 13, lineHeight: 18, fontWeight: '800' },
  copy: { color: colors.inkSoft, fontSize: 13, lineHeight: 19 },
  caution: { backgroundColor: colors.goldPale, borderRadius: 12, padding: 12, color: colors.inkSoft, fontSize: 12, lineHeight: 18 },
  ...
  learnText: { color: colors.sageDark, fontSize: 12, fontWeight: '700', flexShrink: 1, lineHeight: 18 },
  ...
  modalTitle: { color: colors.navy, fontSize: 21, fontWeight: '800', letterSpacing: -0.6, marginTop: 6 },
  close: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center' },
  closeText: { color: colors.navy, fontSize: 27 },
  ...
  tabTextActive: { color: colors.sageDark, fontWeight: '800' },
  modalContent: { padding: 20, paddingBottom: 30, gap: 20 },
  lesson: { gap: 17 },
  lessonTitle: { color: colors.navy, fontSize: 20, lineHeight: 26, fontWeight: '800', letterSpacing: -0.4 },
  ...
  definitionDigit: { color: colors.sageDark, fontSize: 12, fontWeight: '800' },
  definitionTitle: { fontSize: 14, fontWeight: '700', color: colors.navy, marginBottom: 4 },
  formula: { backgroundColor: colors.navy, padding: 18, borderRadius: 18, gap: 7 },
  formulaText: { color: '#DEDDFF', fontSize: 13 },
  formulaResult: { color: colors.white, fontSize: 20, fontWeight: '800' },
  ...
  choiceUnit: { color: colors.muted, fontSize: 12 },
  ...
  sourceTitle: { color: colors.inkSoft, fontSize: 12, fontWeight: '700' },
  ...
  continueText: { color: colors.white, fontWeight: '800', fontSize: 14 },
});
