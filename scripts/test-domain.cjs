...
assert.deepEqual(readExperienceSettings(null), { motion: 'system', welcome: true, activityPrompts: true, onboardingDone: false });
assert.deepEqual(readExperienceSettings({ animations: false, welcome: false }), { motion: 'off', welcome: false, activityPrompts: true, onboardingDone: false });
assert.deepEqual(readExperienceSettings({ animations: 'false' }), { motion: 'system', welcome: true, activityPrompts: true, onboardingDone: false });
